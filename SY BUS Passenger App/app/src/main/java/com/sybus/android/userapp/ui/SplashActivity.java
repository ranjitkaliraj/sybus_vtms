...
public class SplashActivity extends AppCompatActivity {
    ...
    public static String _id="UI:SplashActivity::";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(_id, "Initializing and waiting for 4 seconds for splash screen.");
        //showing the splash screen for 4 seconds before application homescreen start
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                Log.d(_id, "Starting the MainActivity Class.");
        ...
        Log.d(_id, "Initializing and running the progress bar.");
