...
import com.sybus.android.driverapp.util.GoogleApiLocationProvider;
...
public class LocationActivity extends AppCompatActivity implements LocationActivityInterface {
    ...
    private boolean isGoogleApiLocation;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        googleApiLocationProvider = new GoogleApiLocationProvider(LocationActivity.this);
    ...
    private void startLocationUpdate() {
        ...
        //First updating the previous location value and then getting location object.
        if(isGoogleApiLocation == true){
            Log.d(TAG, "GOOGLE API Location Provider.");
            googleApiLocationProvider.startLocationUpdate();
            location = googleApiLocationProvider.getLocation();
            if(location == null){
                Log.d(TAG, "GPS Location null, using location manager instead of google api.");
        ...
        if (isLocationBeingAcquiredForFirstTime == true) {
            ...
            Toast.makeText(LocationActivity.this, "Acquiring GPS location...", Toast.LENGTH_SHORT).show();
    ...
    private void updateLocationInfo(Location location) {
        if (location == null) {
            ...
            if (locationAcquireCount == 2) {
                Toast.makeText(LocationActivity.this, "Unable to acquire GPS Location. Stopping...", Toast.LENGTH_SHORT).show();
                ...
                Toast.makeText(LocationActivity.this, "Unable to acquire GPS Co-ordinates. Retrying...", Toast.LENGTH_SHORT).show();
                Log.d(TAG, "device location returned null.");

                latitude.setText("acquiring...");
                longitude.setText("acquiring...");

                //using timer calling from wrong thread exception occured.
            ...
            if (isLocationAcquiredForFirstTime == false) {
                ...
                if (isGoogleApiLocation){
                    Toast.makeText(this, "TYPE - Google Service GPS.", Toast.LENGTH_SHORT).show();
                }
                else{
                    Toast.makeText(this, "TYPE - Location Manager GPS.", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    private void setOnClickListenerToStartButton() {
        ...
        startButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                isGoogleApiLocation = true;

                cancelButton.setEnabled(false);
                locationUpdateProgressBar.setVisibility(View.VISIBLE);

                Log.d(TAG, "Start button clicked, starting updating location.");
                if(googleApiLocationProvider.isGoogleServiceAvailable()){
                    startLocationUpdateTimer();
                }
                else{
                    isGoogleApiLocation = false;
                    Log.d(TAG, "Google service is not available.");
                    //Toast.makeText(getApplicationContext(), "Google Service is not available.", Toast.LENGTH_LONG).cancel();
                }
            }
        });
    }
    ...
    private void stopLocationUpdate() {
        ...
        if(isLocationAcquiredForFirstTime == true) {
            ...
            googleApiLocationProvider.stopLocationUpdate();
        }
    ...
    private ServiceConnection locationServiceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            locationService.createInterface(LocationActivity.this);
            ...
            public void run() {
                handler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        boolean status = googleApiLocationProvider.canGetLocation();
                        ...
                        if (status) {
                            ...
                            googleApiLocationProvider.displayGpsSettingAlert();
                            //trigerring start button function only if location update is active. this is to avoid to trigger button work ever after once the button is clicked.
                            if (isLocationUpdateStarted == true) {
                                Log.d(TAG, "Currently, start location update is active, stopping it.");
                                //Stopping the location button by clicking the stop button.
