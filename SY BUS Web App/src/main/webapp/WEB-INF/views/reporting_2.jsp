   ...
   <body>
      ...
      <div class="row" style="height:100%; width:auto">
		...
		<div style="margin:-22px">
		  ...
		  <li class="active"><a style="font-weight:normal; background:none;color:#000;border:1px solid #9E9E9E" href="#">Route with Most Traffic Report</a></li>
		...
		<div class="col-sm-10 col-sm-offset-2 col-md-10 col-md-offset-2 main" style="margin-bottom:40px;height:100%; width:89%">
		  ...
		  <div style="margin-left:-42px;margin-right:-42px;margin-top:-32px; height:100%; width:100%">
				...
				<div id="content_header">
				  <h3><span style="color:#4CAF50; margin-left:8px;" id="content_header_title">Route with Most Traffic</span><small id="content_header_subtitle">  Generated Report</small>
				...
				<br>
				<h4 style="float:left">REPORT TITLE: <span style="color:#686868">Route with Most Traffic</span> </h4>
				<br><br>
				...
				<div class="col-xs-12 panel-body" style="min-height:392px; padding:14px; font-family:Arial, Helvetica, sans-serif; font-size:12px">
						...
						<th style="text-align:center" width="30%">AVERAGE TRAFFIC (PER DAY)</th>
						</tr>
						</thead>
						<tbody>	
	  ...
	  <script type="text/javascript">
		$(document).ready(function() {	
			...
			var data1 = {route_name:"Route 1", average_traffic_day:"12 mins"};		//all time data
			var data2 = {route_name:"Route 2", average_traffic_day:"15 mins"};		//today data-
			var data3 = {route_name:"Route 3", average_traffic_day:"19 mins"};		//last week data
			var data4 = {route_name:"Route 4", average_traffic_day:"22 mins"};		//last month data.
			
			//this functions get and load the roport data.
			function loadData(data){
				$("#table tbody").empty();
				$("#table tbody").append('<tr><td>'+1+'</td><td style="text-align:center">'+data.route_name+'</td><td style="text-align:center">'+data.average_traffic_day+'</td></tr>');
			}
