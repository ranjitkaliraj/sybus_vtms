      ...
      <div class="row" style="height:100%; width:auto">
		...
		<div style="margin:-22px">
          ...
          <ul class="nav nav-sidebar" style="padding:2px">
            ...
            <li class="active"><a style="font-weight:bold; background:none;color:#000;border:1px solid #9E9E9E"href="#">MANAGE ROUTE</a></li>
		...
		<div class="col-sm-10 col-sm-offset-2 col-md-10 col-md-offset-2 main" style="margin-bottom:40px;height:100%; width:89%">
		  ...
		  <!-- Nav tabs -->
				  ...
				  <ul class="nav nav-tabs" role="tablist">  
					...
					<li role="presentation" class="active"><a id="route_tab_header" href="#routes_tab" aria-controls="routes_tab" role="tab" data-toggle="tab" style="height:36px; padding:8px">ROUTE</a></li>
					<li role="presentation"><a id="bus_stop_tab_header" href="#bus_stops_tab" aria-controls="bus_stops_tab" role="tab" data-toggle="tab" style="height:36px;padding:8px">BUS STOPS</a></li>
					<li role="presentation"><a id="route_way_tab_header" href="#route_way_tab" aria-controls="route_way_tab" role="tab" data-toggle="tab" style="height:36px;padding:8px">ROUTE WAY</a></li>
					<li role="presentation"><a id="stops_distance_tab_header" href="#stops_distance_tab" aria-controls="stops_distance_tab" role="tab" data-toggle="tab" style="height:36px;padding:8px">STOPS DISTANCE</a></li>

					<!--add, edit and delete buttons-->
					<div class="btn-group" role="group" aria-label="..." style="float:right;margin-right:18px; margin-top:2px">
					  <button id="add_button" data-toggle="tooltip" data-placement="bottom" title="Add" style="background:none;padding:0px; height:28px;width:60px" type="button" class="btn btn-default pull-left tooltip-bottom" title="Add new Route Details"><span class="glyphicon glyphicon-plus"></span></button>
					  <button id="edit_button" data-toggle="tooltip" data-placement="bottom" title="Edit" style="background:none;padding:0px; height:28px;width:60px" type="button" class="btn btn-default pull-left tooltip-bottom" title="Edit and update existing Route Details"><span class="glyphicon glyphicon-edit"></span></button>
					  <button id="delete_button" data-toggle="tooltip" data-placement="bottom" title="Delete" style="background:none;padding:0px; height:28px;width:60px" type="button" class="btn btn-default pull-left tooltip-bottom" title="Delete all or particular Route Details"><span class="glyphicon glyphicon-trash"></span></button>
					</div>
					</ul>
					</div>
				...
				<div id="content_header">
				  <h3><span style="color:#4CAF50" id="content_header_title"></span><small id="content_header_subtitle"></small>
				  <!--Refresh Button-->
				  <button id="content_header_button_refresh" type="button" class="btn btn-sm" data-toggle="tooltip" data-placement="bottom" title="Refresh the list" style="display:none; background-color:#FFF; border:1px solid #9E9E9E; float:right;padding:0px; height:28px;width:80px" onClick="refresh()">
				...
				<button id="content_header_button_close" type="button" class="btn btn-sm" data-toggle="tooltip" data-placement="bottom" title="Exit" style="display:none; background-color:#FFF; border:1px solid #9E9E9E; float:right;padding:0px; height:28px;width:80px">
				...
				<span id="refresh_animation_logo"style="float:right;margin-right:10px; display:none"><img src="images/refresh.gif" height="24" width="24"></span>	
				  </h3>
				</div>
				</div>
				...
				<!--Route section-->
				<!--#####################################################################################################################################-->
				<div role="tabpanel" class="tab-pane fade in active" id="routes_tab" style="height:100%; width:100%;  overflow-y:auto!important">
				...
				<div id="add_route_submit_message_alert" tabindex='1' class="alert in fade alert-success col-md-8" role="alert" style="margin-left:48px;margin-top:20px;display:none;background:none; border:1px solid #595959">
								
				<!--<button id="add_button_message_close" type="button" class="close" data-dismiss="alert" aria-label="Close">
				  <span aria-hidden="true">&times;</span>
				</button>-->
				<h2 style="color:#595959;"><span style="color:#4CAF50" id="add_route_submit_message_alert_title"></span><small id="add_route_submit_message_alert_details"></small></h2>
				<div class="col-md-2">
					<button  type="button" class="btn btn-sm" data-toggle="tooltip" data-placement="bottom" title="Add new Route" style="background:none; border:1px solid #9E9E9E; padding:0px; height:34px;width:100px; margin-left:-10px" onClick="displayAddRouteForm()">ADD NEW</button>
				</div>
				...
				<!--Add edit, delete route Server error message or duplicate data error-->
				<div id="route_section_server_error" class="alert alert-warning row-fluid" role="alert" style="display:none; font-size:14px; height:48px; margin:8px"><strong id="route_section_server_error_title">ERROR OCCURED!!!</strong><small id="route_section_server_error_details"> Something went wrong. Cannot add the Route details at the moment. Please try again later.</small></div>
				 
				<div class="row-fluid container-fluid" style="margin-top:6px">
				<div class="col-md-2"></div>
				<!--add new Route section-->
				<div id="add_route_section" class="col-md-7 panel panel-default" style="border:1px solid #BDBDBD;display:none; margin-top:6px;margin-bottom:50px; height:auto; font-size:12px;padding:0px">
				<div style="background-color:#424242;color:#FFF;font-weight:normal;font-size:16px;text-align:center; padding:8px; height:36px">ADD NEW ROUTE</div>
				<div class="col-md-12" style="padding:0px">
						...
						<div class="form-group row-fluid">
							...
							<div class="input-group col-md-12">
							  <span class="input-group-addon" id="basic-addon1" style="font-weight:normal; width:110px; font-size:12px; color:#000">ROUTE NAME </span>
							  <input id ="add_button_routeName" style="height:28px; font-size:12px;color:#000" type="text" class="form-control" placeholder="Enter Route Name" aria-describedby="basic-addon1">
							</div>
						</div>	
						<div class="form-group row-fluid">
							<!--<label class="col-md-3 control-label"> Add Stops:</label>-->
							<div class="input-group col-md-12">
							<span class="input-group-addon" style="font-weight:normal; font-size:12px; width:110px; color:#000">BUS STOP</span>
							  <select id="add_button_stop_dropdown" style="height:28px; font-size:12px; padding:0px; color:#000" class="form-control tooltip-bottom" placeholder="apple" title="Select Bus stop from the list.">
								<option id="select_stop_from_list">SELECT BUS STOP</option>
							...
							<label class="col-md-10 control-label" style="margin-top:-5px; margin-left:-10px;font-weight:normal; color:#757575; font-size:12px"> Select and add required Bus Stops from the dropdown list.</label>
						<button id="add_busstop_to_route_button" type="button" class="btn btn-sm pull-right" data-toggle="tooltip" data-placement="bottom" title="Add to Bus Stop List." style="border:1px solid #BDBDBD; background:none; margin-top:-8px;margin-bottom:12px; height:24px; width:52px; padding:0px">
						...
						<div class="form-group row-fluid">
					  <div class="panel-heading col-md-12" style="font-weight:bold; background:none; border:none; height:32px; padding:1px;"><h5 style="font-weight:bold">BUS STOP LISTS<small> (You can also drag and drop the rows to re-arrange the order.)</small></h5></div>
					...
					<div class="panel panel-default col-md-12" style="padding:0px">
					  ...
					  <!-- Table -->
					  <table class="table table-condensed table-striped table-bordered"  id="add_button_selected_stop_list" style="font-size:12px">
						  <tbody>
						  </tbody>
					  </table>
					</div>
				...
				<div class="row-fluid col-md-10" style="padding-bottom:20px;margin-left:10px; margin-top:-20px; margin-bottom:-24px">
						<div class="col-md-2">
						<button id="add_button_submit_button" type="button" class="btn btn-sm" style="background:none; border:1px solid #9E9E9E; margin-bottom:20px;height:32px;width:96px;margin-left:-16px;"onClick="submitRouteExtended()"><span class="glyphicon glyphicon-plus"></span> ADD</button>
						</div>
						<div class="col-md-2">
						<button id="add_button_cancel_button" type="button" class="btn btn-sm" style="background:none; border:1px solid #9E9E9E; margin-bottom:20px;height:32px; width:96px;margin-left:5px" onClick="hideAddRouteFormOnly()"><span class="glyphicon glyphicon-remove"></span> CANCEL</button>
						</div>
				<!--submit animation logo-->
				<span id="route_add_loading_icon" data-toggle="tooltip" data-placement="bottom" title="Loading..." style="visibility:hidden; float:left;margin-left:48px; margin-top:3px"><img src="${actionLoadingIcon}" height="24" width="24"></span>	
	
						
						<div class="col-md-8">
						<button id="add_button_reset_button" type="button" data-toggle="tooltip" data-placement="bottom" title="Reset" class="btn btn-sm pull-right" style="margin-right:-102px; margin-top:-28px; background:none; border:1px solid #9E9E9E" onClick="resetAddRouteForm()"><span class="glyphicon glyphicon-repeat"></span></button>
						</div>
						</div>
				...
				<!--Route bus stops map view section-->
				<div tabindex="1" id="route_map_container" class="row-fluid container-fluid col-md-12" style="display:none; padding-left:18px; padding-right:18px; z-index:9999; margin-top:-6px; margin-bottom:24px; height:492px">
				
				<!--loading animation-->
				<div id="route_map_loading" style="display:none; border:1px solid #BDBDBD; height:90%; width:100%;background:url('${loadingIcon}');background-repeat:no-repeat;background-position:center">
				</div>
				
				<!--main map section-->				
				<div id ="route_map" style="display:none, border:1px solid #BDBDBD; height:90%; width:100%">
				</div>
				
				
				<div class="panel-heading" style=" border:1px solid #BDBDBD; height:10%; width:100%; background-color:#424242; padding:0px; padding-left:18px; padding-right:8px">
				<h5 style="font-weight:bold; color:#DDD; margin-top:6px"><span id="route_map_route_name">ROUTE 1</span>
				<small style="color:#BBB; font-size:11.5px">
				Route Stops: <span id="route_map_stop_message">Available</span> | Route Way: <span id="route_map_way_message">dfsfdsf</span>
				<br>
				(The BLUE line displays the Route Way and the Green markers displays the Bus Stops position.)
				</small>
				<button id="route_map_close_button" type="button" class="btn btn-sm" style="float:right; background-color:#424242; color:#CCC; border:1px solid #9E9E9E; float:right;padding:0px; height:24px;width:80px; margin-top:-13px" onClick="closeRouteTabMap()">
				...
				<!--this is temporary heading for route display when add route form appears-->
				<div id="temp_route_heading" class="page-header row-fluid col-md-12" style="display:none; padding-left:18px; padding-right:18px; margin-top:-20px;padding-bottom:0px">
				  <h3><span id="temp_route_heading_title" style="color:#4CAF50">CURRENT ROUTES</span> <small> List of currently available routes. </small>
				  
				  		  
				  <button id="refresh_button" type="button" class="btn btn-sm" style="background-color:#FFF; border:1px solid #9E9E9E; float:right;padding:0px; height:28px;width:80px" onClick="displayLoading(true)" disabled="disabled">
				  <span class="glyphicon glyphicon-refresh" aria-hidden="true"></span> Refresh
				</button>	
				<!--
				<--refresh animation logo--
				<span id="refresh_icon"style="float:right;margin-right:10px"><img src="images/refresh.gif" height="24" width="24"></span>	
			...
			<button id = "edit_option_exit_button" type="button" class="btn btn-sm" style="float:right;background-color:#FFF; border:1px solid #9E9E9E; height:28px;width:80px" onClick="cancelRouteEditOption()">
				...
				<!--Route table list section-->
				<div class="col-md-12 container-fluid" style="padding-left:72px;padding-right:72px; margin-top:0px; font-family:Arial, Helvetica, sans-serif; font-size:12px; height:100%; width:100%;overflow-y:auto!important">

				<!--Save edit route detail status message-->				
			 <div id="route_save_success_message" tabindex="1" class="alert alert-success row-fluid" role="alert" style="display:none; font-size:14px; height:48px; margin-bottom:6px"><strong>Update Successful.</strong><small> New changes to the selected Routes has been successfully updated.</small></div>
			 <div id="route_save_danger_message" tabindex="1" class="alert alert-danger row-fluid" role="alert" style="display:none; font-size:14px; height:48px; margin-bottom:6px"><strong>Update Failed.</strong><small> Something went wrong. New changes to the selected Routes cannot be made at the moment.</small></div>
			 <div id="route_save_already_saved_error_message" tabindex="1" class="alert alert-warning row-fluid" role="alert" style="display:none; font-size:14px; height:48px; margin-bottom:6px"><strong>Unable to Save.</strong><small> No modification has been made to any route details or changes are already saved.</small></div>
			 
			 
			 <!--delete route detail status message-->				
			 <div id="route_delete_success_message" tabindex="1" class="alert alert-success row-fluid" role="alert" style="display:none; font-size:14px; height:48px; margin-bottom:6px"><strong>Delete Successful.</strong><small> Selected Routes has been successfully deleted.</small></div>
			 <div id="route_delete_danger_message" tabindex="1" class="alert alert-danger row-fluid" role="alert" style="display:none; font-size:14px; height:48px; margin-bottom:6px"><strong>Delete Failed.</strong><small> Something went wrong. Deletion to the selected Routes cannot be made at the moment.</small></div>
			 
			 
			<!--Delete route check box to select all-->	
			<div id="display_route_route_delete_select_all_checkbox" style="display:none; width:94px"><div style="float:left; margin-top:3px;font-weight:bold">SELECT ALL: </div><div style="float:right"><input id="route_delete_select_all_checkbox" type="checkbox" aria-label="..." onClick="selectRouteDeleteAllCheckBox()"></div></div>
			
			
			<!--Display message when there is no-route to display in table.-->
			<div class="col-md-1"></div>
			  <div id="display_route_message_alert" class="alert in fade alert-success col-md-9" role="alert" style="display:none; margin-top:12px;background:none; border:1px solid #595959">
				<h2 style="color:#595959;"><span style="color:#4CAF50" id="display_route_message_title">Route not Available.</span><small id="display_route_message_detail">There is nothing to display. Please, add a new route details. Your added details will be displayed here.</small></h2>
				
			</div>

		  <table class="table table-condensed able-striped table-bordered" id="display_route_table" style="display:none">
            <thead>
              <tr style="height:28px; background-color:rgba(0,0,0,0.8);color:#CCC">
			...
			<!--Delete button-->
			  <div id="delete_route_apply_and_cancel_buttons" style="display:none; margin-bottom:6px; margin-top:-6px">
			  <hr>
			  	<button type="button" class="btn btn-sm" style="margin-top:-12px; background-color:#FFF; border:1px solid #9E9E9E; margin-bottom:20px;height:32px; width:96px" onClick="displayRouteDeleteModal()">
				  <span class="glyphicon glyphicon-trash" aria-hidden="true"></span> DELETE
				</button>
				
				 <!--delete option close/cancel button-->
			  	<button type="button" class="btn btn-sm" style="margin-top:-12px; background-color:#FFF; border:1px solid #9E9E9E; margin-bottom:20px;margin-left:5px; height:32px; width:96px" onClick="cancelRouteDeleteOption()">
				  <span class="glyphicon glyphicon-remove" aria-hidden="true"></span> EXIT
				</button>
				</div>				
				<br><br><br><br>
				 ...
				 <!--#####################################################################################################################################-->
				  ...
				  <div role="tabpanel" class="tab-pane fade" id="bus_stops_tab" style="height:100%; width:100%; overflow-y:hidden!important; margin-top:6px">
				...
				<div class="col-md-1"></div>
				<div  tabindex='1' class="alert in fade alert-success col-md-2" role="alert" style="height:156px; width:800px; margin-top:12px; margin-left:60px; background:none; border:1px solid #595959">			
					
					<h2 style="color:#595959;"><span style="color:#4CAF50" id="bus_stop_display_status_message_title"> BUS STOPS NOT AVAILABLE. </span><br><small id="bus_stop_display_status_message_details">Currently, there are no any bus stops details are available to display here. You can add new Bus Stop and added Bus stops will be displayed here.</small></h2>
				</div>
				</div>
								
				<div id="bus_stop_tab_main_container" class="container-fluid col-md-12" style="display:none; height:88.5%; width:100%;  overflow-y:hidden!important">
					<div class="col-md-7" style="height:100%; padding:0px;margin:0px">
					
					
					<div id="display_bus_stop_section" class="panel panel-default" style="padding:5px;height:100%; width:100%; margin:0px;overflow-y:hidden!important;overflow-x:hidden!important">
					
				<!--Bus stop delete status message-->
				 <div id="bus_stop_delete_success_message" class="alert alert-success row-fluid" role="alert" style="display:none; font-size:14px; height:10%; margin:5px;"><strong>Delete Successful.</strong><small> The selected Bus stop has been successfully deleted.</small></div>
				 <div id="bus_stop_delete_danger_message" class="alert alert-danger row-fluid" role="alert" style="display:none; font-size:14px; height:10%; margin:5px"><strong>Delete Failed.</strong><small> Something went wrong. Cannot delete Bus Stop at the moment.</small></div>
				 
				
				<!--Server error message-->
				 <div id="bus_stop_server_danger_message" class="alert alert-danger row-fluid" role="alert" style="display:none; font-size:14px; height:10%; margin:5px"><strong id="bus_stop_server_danger_message_title">ERROR OCCURED!!!</strong><small id="bus_stop_server_danger_message_detail"> Something went wrong. Please, try again later.</small></div>
				 
				
					<!--Check all box for delete section-->
						<div id="delete_bus_stop_route_delete_select_all_checkbox" style="display:none; height:3.5%;border-bottom:1px dotted #BDBDBD">
						<div style="width:102px"><div style="float:left;margin-left:8px;margin-top:0px;font-weight:bold; font-size:12px">SELECT ALL: </div><div style="float:right;margin-top:-3px;"><input id="bus_stop_delete_select_all_checkbox" type="checkbox" aria-label="..." onClick="selectBusStopDeleteAllCheckBox()"></div>
						</div>
						</div>
						
					<!--main table section-->
					<div id="bus_stop_main_table_section" style="height:100%; width: 100%; overflow-y:auto!important; overflow-x:hidden!important">
					
					<!--add bus stop status message.-->
				<div id="add_bus_stop_submit_message_alert" tabindex='1' class="alert in fade alert-success" role="alert" style="height:160px; margin:12px; display:none;background:none; border:1px solid #595959">								
					<button id="add_button_message_close" type="button" class="close" data-dismiss="alert" aria-label="Close" onclick="closeAddBusStopForm()">
					  <span aria-hidden="true">&times;</span>
					</button>
					
					<h2 style="color:#595959;"><span style="color:#4CAF50" id="add_bus_stop_submit_message_alert_title"></span><small id="add_bus_stop_submit_message_alert_details"></small></h2>
					<div class="col-md-6" style="margin-left:-12px">
						<button  type="button" class="btn btn-sm" data-toggle="tooltip" data-placement="bottom" title="Add new BusStop" style="background:none; border:1px solid #9E9E9E; padding:0px; height:34px;width:100px; margin-right:8px; float:left" onClick="displayAddBusStopForm()">ADD NEW</button>
						<button  type="button" class="btn btn-sm" data-toggle="tooltip" data-placement="bottom" title="Exit Form" style="background:none; border:1px solid #9E9E9E; padding:0px; height:34px;width:100px; float:left" onclick="closeAddBusStopForm()">EXIT</button>
					</div>
				</div>
				
				<!--Bus stop saving status message-->								
				 <div id="bus_stop_save_success_message" tabindex="1" class="alert alert-success row-fluid" role="alert" style="display:none; font-size:14px; height:48px; margin:8px"><strong>Update Successful.</strong><small> New changes to the selected Bus stop has been successfully updated.</small></div>
				 <div id="bus_stop_save_danger_message"  tabindex="1" class="alert alert-danger row-fluid" role="alert" style="display:none; font-size:14px; height:48px; margin:8px"><strong>Update Failed.</strong><small> Something went wrong. Cannot update Bus Stop at the moment.</small></div>
				 <div id="bus_stop_save_already_saved_error_message"  tabindex="1" class="alert alert-warning row-fluid" role="alert" style="display:none; font-size:14px; height:48px; margin:8px"><strong>Unable to Save.</strong><small> No modification found on any Bus Stop or changes are already saved.</small></div>
				 

					  					
					<!--Add new bus stop section-->
					<div id="add_bus_stop_section" class="panel panel-default" style="display:none; border:1px solid #BDBDBD; margin:12px; margin-left:72px; margin-right:72px; height:auto; width:auto; padding:0px;overflow-y:auto!important;overflow-x:hidden!important">
					  
					  
					  
					  <div class="panel-heading" style="height:32px; padding:6px; background:none; background-color:#424242; color:#FFF; text-align:center">
					  ...
					  <div class="form-group row-fluid">					  
						<div class="input-group col-md-12">
						  <span class="input-group-addon"  style="width:102px; font-size:12px; color:#000">NAME: </span>
						  <input id ="add_bus_stop_enter_name" tabindex="1" type="text" class="form-control" placeholder="Enter Bus Stop Name" aria-describedby="basic-addon1" style=" height:28px; font-size:12px; border:1px solid #BDBDBD; color:#000">
						</div>					  
					  </div>
					
					
					 <div class="form-group row-fluid" style="padding-left:18px; padding-right:18px;  border:1px solid #BDBDBD; background-color:#E0E0E0">					  
						<div class="input-group col-md-12">
						  <span class="label label-default" style="display:block; font-size:12px;height:42px; padding:14px;background:none; color:#000; ">LOCATION CO-ORDINATES</span>
						</div>		

					  <div class="form-group row-fluid">					  
						<div class="input-group col-md-12">
						  <span class="input-group-addon" style="width:102px; font-size:12px; color:#000">LONGITUDE: </span>
						  <input id ="add_bus_stop_longitude" tabindex="1" type="text" class="form-control" placeholder="longitude co-ordinate" aria-describedby="basic-addon1" style=" height:28px;font-size:12px; border:1px solid #BDBDBD;color:#000">
						</div>
					</div>
					<div class="form-group row-fluid">					  
						<div class="input-group col-md-12">
						  <span class="input-group-addon" style="width:102px; font-size:12px; color:#000">LATITUDE: </span>
						  <input id ="add_bus_stop_latitude" tabindex="1" type="text" class="form-control" placeholder="latitude co-ordinate" aria-describedby="basic-addon1" style=" height:28px;font-size:12px; border:1px solid #BDBDBD; color:#000">
						</div>					  
					  </div>						
					  </div>
					 
				<!--submit buttons-->
				<div class="form-group row-fluid" style="height:28px; padding:0px; margin-bottom:18px">		
				<button id="add_bus_stop_close" type="button" class="btn btn-sm" style="background:none; border:1px solid #9E9E9E; float:right;padding:0px; height:32px;width:96px;margin-left:10px"><span class="glyphicon glyphicon-remove"></span> CANCEL</button>
				<button id="add_bus_stop_add" type="button" class="btn btn-sm" style="background:none; border:1px solid #9E9E9E; float:right;padding:0px; height:32px;width:96px"><span class="glyphicon glyphicon-plus"></span> ADD</button>
							
				<!--submit animation logo-->
				<span id="add_bus_stop_loading_icon" data-toggle="tooltip" data-placement="bottom" title="Loading..." style="display:none; float:left;margin-left:20px; margin-top:3px"><img src="${actionLoadingIcon}" height="24" width="24"> <span style="font-weight:bold; font-size:11px; "></span></span>	
				</div>
					  ...
					  <div id="temp_bus_stop_table_header" style="display:none; margin-top:32px;margin-left:10px; margin-bottom:-8px">
				  <h4><span style="color:#4CAF50">CURRENT BUS STOPS</span><small> List of currently available Bus Stops.</small></h4>
				  </div>
				  <!--No bus stop available message.-->
				  <h2 id="display_bus_stop_table_not_available" style="display:none; color:#CCC; margin-left:140px;">Not Available</h2>
					  
					  <div class="panel-body" style="padding:0px; margin-left:-15px; width:105%; font-family:Arial, Helvetica, sans-serif; font-size:12px">	

						
						<!--Bus stop table list section-->
						<div class="container-fluid">
										  
						<table class="table table-condensed table-striped table-bordered" id="display_bus_stop_table">
						<thead>
						  <tr style="background-color:rgba(0,0,0,0.8);color:#CCC">
							<th style="text-align:center" width="8%">SN</th>
							<th style="text-align:center" swidth="50%">BUS STOP NAME</th>
				  ...
				  <div id="delete_bus_stop_apply_and_cancel_buttons" style="padding:3px;margin-top:5px; height:10%; width:100%; display:none; border-top:1px dotted #BDBDBD">
					<button type="button" class="btn btn-sm" style="background-color:#FFF; border:1px solid #9E9E9E; margin-left:2px;margin-bottom:20px;height:32px; width:96px" onClick="displayBusStopDeleteModal()">
					  <span class="glyphicon glyphicon-trash" aria-hidden="true"></span> DELETE
					</button>
					
					 <!--delete option close/cancel button-->
					<button type="button" class="btn btn-sm" style="background-color:#FFF; border:1px solid #9E9E9E; margin-bottom:20px;margin-left:5px; height:32px; width:96px" onClick="cancelBusStopDeleteOption()">
					  <span class="glyphicon glyphicon-remove" aria-hidden="true"></span> EXIT
					</button>
					
												
				<!--delete animation logo-->
				<span id="bus_stop_delete_loading_icon" data-toggle="tooltip" data-placement="bottom" title="Loading..." style="display:none; float:right;margin-right:306px; margin-top:3px"><img src="${actionLoadingIcon}" height="24" width="24"> <span style="font-weight:bold; font-size:11px; "></span></span>	
				</div>
				</div>
				
				
				</div>
					<div id="bus_stop_map_container" class="col-md-5" style="height:100%; padding:0px;margin:0px">
					<div class="panel panel-default" style="padding:0px; height:100%; width:100%">

					
					  <!--Bus stop map section-->
					  <div  id="bus_stop_map" class="panel-body" style="height:86%; width:99.6%; visibility:visible; padding:0px; margin:1px">
			
					  </div>
					  
					  <div class="panel-heading" style="height:14%;background:none; background-color:#212121; color:#CCC">
						<h4 id="bus_stop_display_co_ordinates_on_map_footer" class="panel-title" style=" margin-top:-2px;">BUS STOP: <span id="bus_stop_name">Not Selected</span><br><small>LONGITUDE: <span id="bus_stop_longitude">Not Available</span>, LATITUDE: <span id="bus_stop_latitude">Not Available</span></small>
						<br><small>(Select and click on the Bus Stop in the table list to view its location here.)</small>
						</h4>	
						<h4 id="bus_stop_add_co_ordinates_on_map_footer" class="panel-title" style="display:none; margin-top:-6px;">ADD CO-ORDINATES <br><small>LONGITUDE: <span id="add_bus_stop_map_longitude">Not Available</span>, LATITUDE: <span id="add_bus_stop_map_latitude">Not Available</span></small>
						<br><small>(Pan around and click to pin location in the map)</small>
						
						<button id="bus_stop_map_footer_pin_location_button" type="button" class="btn btn-sm" style="background:none; background-color:#212121; border:1px solid #9E9E9E; float:right;padding:0px; height:42px; width:96px; margin-top:-30px; color:#CCC"><span class="glyphicon glyphicon-pushpin"></span> ADD</button>
						</h4>						
					  </div>
				...
				<!--#####################################################################################################################################-->
				  <!--route way section-->
				  <!--#####################################################################################################################################-->
				  <div role="tabpanel" class="tab-pane fade" id="route_way_tab" style="height:100%; width:100%">
				...
				<div  tabindex='1' class="alert in fade alert-success col-md-2" role="alert" style="height:156px; width:800px; margin-top:12px; margin-left:60px; background:none; border:1px solid #595959">			
					...
					<h2 style="color:#595959;"><span style="color:#4CAF50" id="route_way_display_status_message_title"> ROUTE WAYS NOT AVAILABLE. </span><br><small id="route_way_display_status_message_details">Currently, there are no any bus stops details are available to display here. You can add new Route and added Bus stops will be displayed here.</small></h2>
				</div>
				</div>
				
				
				<div id="route_way_tab_main_container" class="container-fluid col-md-12" style="display:nonek; height:88.5%; width:100%; overflow-y:hidden!important; margin-top:6px; ">
				
				<!--Left route list panel -->
					<div class="col-md-3 panel panel-default" style="height:100%; padding:0px;margin:0px">
					
						
					<!--main table section-->
					<div id="route_way_main_table_section" style="height:100%; width: 100%; padding:0px; overflow-y:auto!important;">
					
					 
				   <!--Update Success Message-->
				   <div id="route_way_update_failed_message" class="alert alert-danger row-fluid" role="alert" style="display:none; font-size:14px; height:10%; margin:5px; padding:4px; padding-left:12px"><strong>Update Failed.</strong><small> Something went wrong. Cannot update Route Way at the moment.</small></div>
				  
				  <div id="route_way_update_success_message" class="alert alert-success row-fluid" role="alert" style="display:none; font-size:14px; height:10%; margin:5px; padding:4px; padding-left:12px"><strong>Update Successful.</strong><small> The selected Route Way has been successfully updated.</small></div>
				  
				  
				  
					  <!--Table heading for added route way list-->
					  <div id="temp_route_way_table_header" style="display:nones; margin-left:10px; margin-bottom:-8px">
				  <h4><span style="color:#4CAF50">WAYS ADDED</span><br><small> List of currently available Route ways.</small></h4>
				  </div>
				  
				 
				   <div id="bus_stop_delete_danger_message" class="alert alert-danger row-fluid" role="alert" style="display:none; font-size:14px; height:10%; margin:5px"><strong>Delete Failed.</strong><small> Something went wrong. Cannot delete Bus Stop at the moment.</small></div>
				  <!--No bus stop available message.-->
				  <h2 id="display_route_way_added_table_not_available" style="display:none; color:#CCC; margin-left:32px;">Not Available</h2>
					  
					 
						<!--Bus stop table list section-->
						<div class="container-fluid" style="padding:0px; font-family:Arial, Helvetica, sans-serif; font-size:12px">
										  
						<table class="table table-condensed table-striped table-bordered" id="display_added_route_way_table">
					  ...
					  <div id="temp_route_way_table_header" style="display:nones; margin-left:10px; margin-bottom:-8px">
				  <h4><span style="color:#4CAF50">NOT ADDED</span><br><small> Ways are not added in following routes.</small></h4>
				  </div>
				  <!--No bus stop available message.-->
				  <h2 id="display_route_way_not_added_table_not_available" style="display:nohne; color:#CCC; margin-left:32px;">Not Available</h2>
					  
					 
						<!--Bus stop table list section-->
						<div class="container-fluid" style="padding:0px; font-family:Arial, Helvetica, sans-serif; font-size:12px">
										  
						<table class="table table-condensed table-striped table-bordered" id="display_not_added_route_way_table">
					...
					<div id="route_way_map_container" class="col-md-9" style="height:100%;padding:0px; margin:0px">
					<div class="panel panel-default" style="padding:0px; height:100%; width:99.5%; margin-left:1px; border:1px solid #BDBDBD">
					
					<div style="height:85%; width:100%; padding:0px">
					<!--loading animation-->
					<div id="route_way_map_loading" style="display:none; background:url('${loadingIcon}');background-repeat:no-repeat;background-position:center center;height:100%; width:100%;"></div>
								
					  <!--Bus stop map section-->
					  <div  id="route_way_map" class="panel-body" style="height:100%; width:100%; padding:0px">
			
					  </div>
					  </div>
					  <div class="panel-heading" style="height:15%;background:none; background-color:#424242; color:#CCC">
						
						
						<!--no mode-->
						<h4 id="route_way_no_mode_footer" class="panel-title" style="margin-top:-8px">
						<small style="">MODE: NOT SELECTED</small><hr style="margin:0px; padding:3px">
						ROUTE NAME: <span>NOT SELECTED</span>
						<br><small style="font-size:11px">(You can select to add, edit or view route ways for selected route from left panel option menu.)</small>					
						</h4>	
						
						
						<!--view mode-->
						<h4 id="route_way_view_mode_footer" class="panel-title" style="display:none; margin-top:-8px">
						<small style="">VIEW MODE</small>
					
						<span id="route_way_view_mode_exit" style="float:right; cursor:pointer; margin-top:1px" data-toggle="tooltip" placement="top" title="Exit Mode" class="glyphicon glyphicon-remove-circle"></span>
						
						<hr style="margin:0px; padding:3px; margin-top:4px">
						ROUTE NAME: <span id="route_way_view_mode_name">Not Selected</span>
						...
						<br><small style="font-size:11px">(Please, select to view Route Way from the option menu for selected Route in Ways Added Route Way section left.)</small>					
						</h4>
						
						<!--add mode-->
						<h4 id="route_way_add_mode_footer" class="panel-title" style="display:none; margin-top:-6px;">
						...
						<button  id="route_way_add_mode_exit" type="button" class="btn btn-sm" style="background:none; color:#CCC; border:1px solid #9E9E9E; padding:0px; height:18px;width:62px;float:right" onClick=""><span class="glyphicon glyphicon-remove"></span> EXIT</button>
						
						
						<span style="margin-top:6px;margin-right:18px;float:right;font-size:11px">You can add marker following route way in the Map above. Note: Click once to add marker and twice to remove it.</span>
						
						<hr style="margin:0px; padding:3px; margin-top:4px">
						
						
						ROUTE NAME: <span id="route_way_add_mode_name">Not Selected</span>
						<button  id="route_way_add_mode_add_button" type="button" class="btn btn-sm" style="background:none; color:#CCC; border:1px solid #9E9E9E; padding:0px; height:28px;width:100px;float:right;margin-top:3px" onClick=""><span class="glyphicon glyphicon-plus"></span> ADD WAY</button>
						
						<button  id="route_way_add_mode_way_list_button" type="button" class="btn btn-sm" style="background:none; color:#CCC; border:1px solid #9E9E9E; padding:0px; height:28px;width:100px;float:right;margin-top:3px" onClick=""><span class="glyphicon glyphicon-list-alt"></span> RAW LIST</button>
						
						<br><small style="font-size:11px">(Please, select to add Route Way from the option menu for selected Route in Not Added Route Way section left.)</small>
						
						</h4>
						
						
						<!--edit/update mode-->
						<h4 id="route_way_edit_mode_footer" class="panel-title" style="display:none; margin-top:-6px;">
						<small style="">EDIT WAY MODE</small>
						<!--<span id="route_way_add_mode_exit" style="float:right; cursor:pointer; margin-top:1px" data-toggle="tooltip" placement="top" title="Cancel" class="glyphicon glyphicon-remove-circle"></span>-->
						<button  id="route_way_edit_mode_exit" type="button" class="btn btn-sm" style="background:none; color:#CCC; border:1px solid #9E9E9E; padding:0px; height:18px;width:62px;float:right" onClick=""><span class="glyphicon glyphicon-remove"></span> EXIT</button>
						...
						ROUTE NAME: <span id="route_way_edit_mode_name">Not Selected</span>
						<button  id="route_way_update_mode_add_button" type="button" class="btn btn-sm" style="background:none; color:#CCC; border:1px solid #9E9E9E; padding:0px; height:28px;width:100px;float:right;margin-top:3px" onClick=""><span class="glyphicon glyphicon-arrow-up"></span> UPDATE WAY</button>
						
						<button  id="route_way_edit_mode_way_list_button" type="button" class="btn btn-sm" style="background:none; color:#CCC; border:1px solid #9E9E9E; padding:0px; height:28px;width:100px;float:right;margin-top:3px" onClick=""><span class="glyphicon glyphicon-list-alt"></span> RAW LIST</button>
						
						<br><small style="font-size:11px">(Please, select to edit Route Way from the option menu for selected Route in Added Route Way section left.)</small>
			...
			<!--#####################################################################################################################################-->
				  ...
				  <!--#####################################################################################################################################-->
				  <div role="tabpanel" class="tab-pane fade" id="stops_distance_tab" style="height:100%; width:100%">
	
					<span id="stops_distance_span_container">  <!--This span is used for hiding the section when reloading or loading-->
	
	
					 <!--status message to display when no bus stops are available to display.-->
				<div id="stops_distance_display_status_message" style="display:none">
				<div class="col-md-1"></div>
				<div  tabindex='1' class="alert in fade alert-success col-md-2" role="alert" style="height:156px; width:800px; margin-top:12px; margin-left:60px; background:none; border:1px solid #595959">			
					
					<h2 style="color:#595959;"><span style="color:#4CAF50" id="stops_distance_display_status_message_title"> ROUTE WAYS NOT AVAILABLE. </span><br><small id="stops_distance_display_status_message_details">Currently, there are no any bus stops details are available to display here. You can add new Route and added Bus stops will be displayed here.</small></h2>
				</div>
				</div>
				
				
				<div id="stops_distance_tab_main_container" class="container-fluid col-md-12" style="display:nonek; height:88.5%; width:100%; overflow-y:hidden!important; margin-top:6px; ">
				
				
				
				
				<!--Left route list panel -->
					<div class="col-md-4 panel panel-default" style="height:100%; padding:0px;margin:0px">
					
						
					<!--main table section-->
					<div id="stops_distance_main_table_section" style="height:100%; width: 100%; padding:0px; overflow-y:auto!important;">

				  
					  <!--Table heading for added route way list-->
					  <div id="stops_distance_left_panel_table_header" style="display:nones; margin-left:10px; margin-bottom:-8px">
				  <h4><span style="color:#4CAF50">ROUTES</span><br><small> List of currently available Routes.</small></h4>
				  </div>
				  
				  <!--No bus stop available message.-->
				  <h2 id="stops_distance_routes_not_available_msg" style="display:none; color:#CCC; margin-left:32px;">Not Available</h2>
					  
					 
						<!--Bus stop table list section-->
						<div class="container-fluid" style="padding:0px; font-family:Arial, Helvetica, sans-serif; font-size:12px">
										  
						<table class="table table-condensed table-striped table-bordered" id="stops_distance_route_table">
					...
					<!--Right map view panel-->
					<div id="stops_distance_container" class="col-md-8" style="height:100%;padding:0px; margin:0px">
					<div class="panel panel-default" style="padding:0px; height:100%; overflow-y:hidden!important; width:99.5%; margin-left:1px; border:1px solid #BDBDBD">
					
										  <div style="display:nones; margin:0px; margin-left:10px; height:9%">
				  <h4>
				  <span style="color:#4CAF50">STOPS DISTANCE</span>
				  <br>
				  <small> List of distance to all the available Bus stops from the starting Bus stop for particular Route. </small>	
					...
					<div style="height:91%; width:100%; padding:0px; text-align:center; overflow-y:auto!important">
					<!--loading animation-->
					<div id="stops_distance_right_panel_loading" style="display:none; background:url('${loadingIcon}');background-repeat:no-repeat;background-position:center center;height:100%; width:100%; overflow-x:hidden; overflow-y:hidden"></div>
						...
						<!--Bus stop table list section-->
						<div class="container-fluid" style="padding:0px; font-family:Arial, Helvetica, sans-serif; font-size:12px; padding:18px; margin-top:-12px; overflow-y:auto!important">
							
					 <!--No bus stop available message.-->
				  <h5 id="stops_distance_distance_not_set_msg" style="display:none; font-size:11px">Stops distance is not set. Please, click to EDIT Button on the left panel option menu to add distance.</h5>

				  
						<table class="table table-condensed table-striped table-bordered" id="stops_distance_table">
						<thead>
						<tr style="background:#424242; color:#CCC">
						<th style="text-align:center" width="5%">SN</th>
						<th style="text-align:center" width="30%">DISTANCE (KM)</th>
						...
						<div id="stops_distance_save_succes_message" class="alert alert-success row-fluid" role="alert" style="display:none; font-size:14px; height:10%; margin:5px"><strong>SAVE SUCCESSFUL.</strong><small> The distance between the Bus stops of selected route has been successfully saved.</small></div>
						
						<div id="stops_distance_save_failed_message" class="alert alert-danger row-fluid" role="alert" style="display:none; font-size:14px; height:10%; margin:5px"><strong>Delete Failed.</strong><small> Something went wrong. Cannot save Bus Stop distance at the moment.</small></div>
						
						
						
				<!--Update/Add and cancel bus stop button-->
				  <div id="stops_distance_save_exit_buttons" style="text-align:left; padding:3px; padding-left:0px; margin-top:5px; height:10%; width:100%; display:none; float:left; border-top:1px dotted #BDBDBD">
					<button type="button" class="btn btn-sm" style="background-color:#FFF; border:1px solid #9E9E9E; margin-left:2px;margin-bottom:20px;height:32px; width:96px" onClick="saveStopsDistance()">
					  <span class="glyphicon glyphicon-trash" aria-hidden="true"></span> SAVE
					</button>
					
					 <!--delete option close/cancel button-->
					<button type="button" class="btn btn-sm" style="background-color:#FFF; border:1px solid #9E9E9E; margin-bottom:20px;margin-left:5px; height:32px; width:96px" onClick="cancelStopsDistanceAdd()">
					  <span class="glyphicon glyphicon-remove" aria-hidden="true"></span> EXIT
					</button>
					
												
				<!--delete animation logo-->
				<span id="stops_distance_save_loading_icon" data-toggle="tooltip" data-placement="bottom" title="Loading..." style="display:none; float:right;margin-right:306px; margin-top:3px"><img src="${actionLoadingIcon}" height="24" width="24"> <span style="font-weight:bold; font-size:11px; "></span></span>	
				</div>
				
						</div>
						
					 <!--No bus stop available message.-->
				  <h1 id="stops_distance_distance_not_available_msg" style="display:nonde; color:#CCC; margin-top:120px">Not Available</h1>
...
<!--loading icon animation-->
		...
		<div id="loading_0" style="background:url('${loadingIcon}');background-repeat:no-repeat;background-position:center center;height:auto; width:auto; position: absolute;top:0;bottom: 0;left: 0;right: 0;margin-left:120px; position:absolute; z-index:9999; display:none"></div>
			...
			<div class="modal-content">
			  ...
			  <div class="modal-footer">
				...
				<button id="action_modal_delete" type="button" class="btn btn-sm" data-dismiss="modal" style="background:none; border:1px solid #9E9E9E; float:right;padding:0px; height:32px;width:96px"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span> DELETE</button>
					...
					<!--Action Modal Exit-->
		<div id="action_modal_exit" class="modal fade"  style="margin-top:120px; padding:40px">
		  <div class="modal-dialog">
			<div class="modal-content">
			  <div class="modal-header" style="height:42px; padding:8px; border-top-left-radius:5px; border-top-right-radius:5px;background:#424242; color:#FFF; text-align:center">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
			  ...
			  <div class="modal-footer">
				<button id="action_modal_exit_cancel" type="button" class="btn btn-sm" data-dismiss="modal" style="background:none; border:1px solid #9E9E9E; float:right;padding:0px; height:32px;width:96px;margin-left:10px"> 
				<span class="glyphicon glyphicon-remove" aria-hidden="true"></span> CANCEL</button>
				<button id="action_modal_exit_ok" type="button" class="btn btn-sm" data-dismiss="modal" style="background:none; border:1px solid #9E9E9E; float:right;padding:0px; height:32px;width:96px"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span> OK</button>
			  </div>
			</div><!-- /.modal-content -->
		  </div><!-- /.modal-dialog -->
		</div><!-- /.modal -->
		...
		<div id="modal_update_route" class="modal fade" style="height:100%; margin-top:20px;" data-keyboard="false" data-backdrop="static">
		  <div class="modal-dialog" role="document">
			<div class="modal-content">
			  <div class="modal-header" style="height:38px; padding:8px; background:#424242; color:#FFF;border-top-left-radius:5px; border-top-right-radius:5px; border:1px solid rgba(255,255,255,0.3); text-align:center">
				<h4 id="modal_update_route_title" class="modal-title">UPDATE ROUTE DETAILS</h4>
			  </div>
			  <div id="edit_route_modal_body" class="modal-body">
				<!--Edit main content-->
								...
								<div class="form-group row-fluid">
									<!--<label class="col-md-3 control-label"  style="margin-top:6px">Add Name:</label>-->
									<div class="input-group col-md-12">
									  <span class="input-group-addon" id="basic-addon1" style="font-weight:normal; font-size:12px; width:110px; color:#000">ROUTE NAME</span>
									  <input id ="modal_update_route_routeName" tabindex="1" type="text" class="form-control" placeholder="Enter Route Name" aria-describedby="basic-addon1"style="font-size:12px; padding-left:10px; color:#000;">
									</div>
								</div>	
								<div class="form-group row-fluid">
									<!--<label class="col-md-3 control-label"> Add Stops:</label>-->
									<div class="input-group col-md-12">
									<span class="input-group-addon" style="font-weight:normal;font-size:12px; width:110px; color:#000">BUS STOP</span>
									  <select id="modal_update_route_stop_dropdown" class="form-control tooltip-bottom" placeholder="apple" title="Select Bus stop from the list." style="height:28px; font-size:12px; padding:0px; color:#000">
										<option id="update_select_stop_from_list">SELECT BUS STOP</option>
										<!--<option>Kalimati Bus Station</option>
										<option>Soyambhu Bus Station</option>
										<option>Kalanki Bus Station</option>
										<option>SahidGet Bus Station</option>
							...
							<div class="row-fluid form-group">
							<label class="col-md-10 control-label" style="margin-top:-5px; margin-left:-10px;font-weight:normal; color:#757575; font-size:12px"> Select and add required Bus Stops from the dropdown list.</label>
						<button id="modal_button_add_busstop_to_list" type="button" class="btn btn-sm pull-right" data-toggle="tooltip" data-placement="bottom" title="Add to Bus Stop List." style="border:1px solid #BDBDBD; background:none; margin-top:-8px;margin-bottom:12px; height:24px; width:52px; padding:0px" onClick="addFromDropDownToStopList()">
						  <span class="glyphicon glyphicon-plus" aria-hidden="true"></span>
						</button>
						</div>
					...
					<div class="panel panel-default col-md-12" style="padding:0px">
					  ...
					  <!-- Table -->
					  <table class="table table-condensed table-striped table-bordered"  id="modal_update_route_selected_stop_list" style="font-size:12px">
						  <tbody>
						  </tbody>
					  </table>
					</div>
			  ...
			  <div class="modal-footer" style="margin-top:12px; margin-bottom:-10px">
				...
				<div class="form-group row-fluid">		
				<button id="route_update_close_button" type="button" class="btn btn-sm" data-dismiss="modal" style="background:none; border:1px solid #9E9E9E; float:right;padding:0px; height:32px;width:96px; margin-left:10px"><span class="glyphicon glyphicon-remove"></span> CLOSE</button>
				<button id="route_update_submit_button" type="button" class="btn btn-sm" style="background:none; border:1px solid #9E9E9E; float:right;padding:0px; height:32px;width:96px"><span class="glyphicon glyphicon-circle-arrow-left"></span> UPDATE</button>
							
				<!--submit animation logo-->
				<span id="route_update_loading_icon" data-toggle="tooltip" data-placement="bottom" title="Loading..." style="display:none; float:left;margin-left:20px; margin-top:3px"><img src="${actionLoadingIcon}" height="24" width="24"> <span style="font-weight:bold; font-size:11px; "></span></span>	
				</div>
			 ...
			 <div id="route_update_success_message" class="alert alert-success row-fluid" role="alert" style="display:none; height:48px; margin-bottom:-8px"><strong>Update Successful.</strong><small> New changes to the selected Route has been successfully updated.</small></div>
			 <div id="route_update_error_message" class="alert alert-danger row-fluid" role="alert" style="display:none; height:48px; margin-bottom:-8px"><strong>Update Failed.</strong><small> Error occured while making updating the new changes of selected Route.</small></div>
			 <div id="route_update_warning_message" tabindex="1" class="alert alert-warning row-fluid" role="alert" style="display:none; height:48px; margin-bottom:-8px"><strong>Information Invalid.</strong><small> --set by javascript--</small></div>
				</div>
			</div><!-- /.modal-content -->
		  </div><!-- /.modal-dialog -->
		</div><!-- /.modal -->
		...
		<div class="modal fade" id="modal_update_bus_stop" style="height:100%; margin-top:20px;" data-keyboard="false" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		  <div class="modal-dialog" role="document">
			<div class="modal-content">
			  <div class="modal-header" style="height:38px; padding:8px; background:#424242; color:#FFF;border-top-left-radius:5px; border-top-right-radius:5px; border:1px solid rgba(255,255,255,0.3); text-align:center">
				<h4 id="modal_update_route_title" class="modal-title">UPDATE BUS STOP DETAILS</h4>
			  </div>
			  <div class="modal-body">
				
				<!--############################# FORM SECTION-->
								<div class="panel-body" style="border:1px solid #BDBDBD; height:152px; margin:-8px">	
								  <div class="form-group row-fluid" style="margin-top:-8px">					  
									<div class="input-group col-md-12">
									  <span class="input-group-addon"  style="width:102px; font-size:12px; color:#000">NAME: </span>
									  <input id ="update_bus_stop_enter_name" tabindex="1" type="text" class="form-control" placeholder="Enter Bus Stop Name" aria-describedby="basic-addon1" style=" height:28px; font-size:12px; border:1px solid #BDBDBD; color:#000">
									</div>					  
								  </div>
								
								
								 <div class="form-group row-fluid" style="padding-left:18px; padding-right:18px;  border:1px solid #BDBDBD; background-color:#E0E0E0; height:96px; margin-top:-6px">					  
									<div class="input-group col-md-12" style="margin-top:-6px">
									  <span class="label label-default" style="display:block; font-size:12px;height:28px; padding:14px;background:none; color:#000; ">LOCATION CO-ORDINATES</span>
									</div>		

								  <div class="form-group row-fluid">					  
									<div class="input-group col-md-12">
									  <span class="input-group-addon" style="width:102px; font-size:12px; color:#000">LONGITUDE: </span>
									  <input id ="update_bus_stop_longitude" tabindex="1" type="text" class="form-control" placeholder="longitude co-ordinate" aria-describedby="basic-addon1" style=" height:28px;font-size:12px; border:1px solid #BDBDBD;color:#000">
									</div>
								</div>
								<div class="form-group row-fluid" style="margin-top:-10px">					  
									<div class="input-group col-md-12">
									  <span class="input-group-addon" style="width:102px; font-size:12px; color:#000">LATITUDE: </span>
									  <input id ="update_bus_stop_latitude" tabindex="1" type="text" class="form-control" placeholder="latitude co-ordinate" aria-describedby="basic-addon1" style=" height:28px;font-size:12px; border:1px solid #BDBDBD; color:#000">
									</div>					  
								  </div>						
								  </div>
				...
				<!--############################# MAP SECTION-->
					 <div  id="bus_stop_update_map"  style="height:280px; margin-top:16px; margin-left:-7px; margin-right:-7px; border:1px solid #BDBDBD">
			
					  </div>
					  <div class="panel-heading" style="height:42px;background:none; background-color:#212121; color:#CCC; margin-bottom:-10px;margin-left:-7px; margin-right:-7px">
						<h5 id="bus_stop_update_co_ordinates_on_map" class="panel-title" style="margin-top:-6px;">ADD CO-ORDINATES 
						
						<br><small>LONGITUDE: <span id="update_bus_stop_map_longitude">Not Available</span>, LATITUDE: <span id="update_bus_stop_map_latitude">Not Available</span></small>
												
						<button id="update_bus_stop_map_footer_pin_location_button" type="button" class="btn btn-sm" style="background:none; background-color:#212121; border:1px solid #9E9E9E; float:right;padding:0px; height:32px; width:96px; margin-top:-16px; color:#CCC"><span class="glyphicon glyphicon-pushpin"></span> ADD</button>
						</h5>						
					  </div>	  
			  ...
			  <div class="modal-footer" style="height:40px; padding:5px">							  
				<div class="form-group row-fluid">		
				<button id="bus_stop_update_close_button" type="button" class="btn btn-sm" data-dismiss="modal" style="background:none; border:1px solid #9E9E9E; float:right;padding:0px; height:32px;width:96px; margin-left:10px"><span class="glyphicon glyphicon-remove"></span> CLOSE</button>
				<button id="bus_stop_update_submit_button" type="button" class="btn btn-sm" style="background:none; border:1px solid #9E9E9E; float:right;padding:0px; height:32px;width:96px"><span class="glyphicon glyphicon-circle-arrow-left"></span> UPDATE</button>
							
				<!--submit animation logo-->
				<span id="bus_stop_update_loading_icon" data-toggle="tooltip" data-placement="bottom" title="Loading..." style="display:none; float:left;margin-left:20px; margin-top:3px"><img src="${actionLoadingIcon}" height="24" width="24"> <span style="font-weight:bold; font-size:11px; "></span></span>	
				</div>
			  </div>
			  <!--Status messages-->
			  <div class="form-group container-fluid">
			 <div id="bus_stop_update_warning_message" tabindex="1" class="alert alert-danger row-fluid" role="alert" style="display:none; height:48px; margin-bottom:-8px;margin-left:-7px; margin-right:-7px;margin-top:5px"><strong>Information Invalid.</strong><small> --set by javascript--</small></div>
			</div>
			</div>
		  </div>
		</div>
	  ...
	  //Hide the route add section when page is loaded and display it if add is clicked or hide is if hide it clicked.
			...
			function refresh(){	
				...
				*/
				...
				//IF HIDE THIS BUS STOP TAB THE ROUTE WAY TAB WILL NOT DISPLAYED MAY BE BUG>>>>
					...
					setTimeout(function(){						
					//	$("#loading_1").fadeOut();					
					//	$("#bus_stop_span_container").fadeIn();		// loading will fadeout in loadBusStopData and same with table loadin.
			...
			function firstTimeTabLoadinAnimation(){
				...
				if(first_time_route_tab_loaded==false && globalTabName=="route"){			
					...
					$.when(loadRouteData()).done(function(){
						setTimeout(function(){						
							$("#loading_1").fadeOut();					
							$("#route_tab_span_container").fadeIn();
						},800);
				...
				//bus stop tab section
				if(first_time_bus_stop_tab_loaded==false && globalTabName=="bus_stop"){			
					$("#loading_1").fadeIn();	
					$("#bus_stop_span_container").hide();
			...
			function loadRouteData(){
				...
				setTimeout(function(){
				$("#loading_0").fadeIn();
				routeCollection = [];		//emptying first   eg. in case of refresh.
				...
				$.ajax({
					...
					success : function(data) {
						console.log("SUCCESS LOADING ROUTE DATA");
						routeCollection = data;	
						
						//alert(JSON.stringify(routeCollection));
						//alert(routeCollection.length);
						...
						if (routeCollection.length==0){
							...
							console.log("Now, adding data to the table.");
					...
					error : function(e) {
						console.log("ERROR WHILE LOADING ROUTE DATA");
						routeCollection = [];		
						$("#loading_0").fadeOut();
					},
					done : function(e) {
		...
		//var addRouteServerStatus = false;
		function addRouteToServer(route_name, stop_lists){
			var date = new Date();
			console.log("Before add route ajax start: "+date.getHours()+":"+date.getMinutes()+":"+date.getSeconds());
			
			console.log("Addin the route to the server.");
			//the following json object identifier name (name, addedRouteStopNames) must match with Server Model Java object field attribute.
			var routeObject = {name:route_name, addedRouteStopNames:stop_lists};
			...
			$.ajax({
				...
				success : function(status) {
					...
					//addRouteServerStatus = status;
					afterAddRouteData(true);
				},
				error : function(e) {
					console.log("ERROR WHILE ADDING ROUTE DATA");
					//addRouteServerStatus = false;
					afterAddRouteData(false);
				},
				done : function(e) {
					console.log("DONE");
					//addRouteServerStatus = true;
				}
			});
		}
		
		
		//var updateRouteServerStatus = false;
		function updateRouteToServer(routeLists){
			//{name:tempStoredRouteNameToUpdate, new_name:route_name, stops:stops};
			//setting some time delay for loading animation.
			setTimeout(function(){
				var date = new Date();
				console.log("Before ajax start: "+date.getHours()+":"+date.getMinutes()+":"+date.getSeconds());
				
				console.log("Updating the routes to the server.");
				
				var update = {updateRouteData:routeLists};
				$.ajax({
					type : "POST",
					contentType : "application/json",
					url : "update_route",
					...
					success : function(status) {
						...
						afterUpdateRouteData(true);
					},
					error : function(e) {
						console.log("ERROR WHILE ADDING ROUTE DATA");
						//updateRouteServerStatus = false;	
						afterUpdateRouteData(false);						
					},
					done : function(e) {
						console.log("DONE");
		...
		//var deleteRouteToServerStatus = false;
		function deleteRouteToServer(routeNamesList){
			//alert(routeNames);
			//some loading animatoin delay before submit.
			setTimeout(function(){
				var date = new Date();
				console.log("Before ajax start: "+date.getHours()+":"+date.getMinutes()+":"+date.getSeconds());
				
				console.log("Deleting the routes to the server.");
				...
				$.ajax({
					...
					contentType : "application/json",
					url : "delete_route",
					data : JSON.stringify(routeNamesList),
					dataType : 'json',
					timeout : 100000,
					success : function(status) {
						console.log("SUCCESS ADDING ROUTE DATA");
						//deleteRouteToServerStatus =  status;
						//console.log(status);
						
						var date = new Date();
						console.log("This is before Delete time.. : "+date.getHours()+":"+date.getMinutes()+":"+date.getSeconds());
						
						setTimeout(function(){
							afterDeleteRoute(true);		//this code was inside submit function after deleteRouteToServer function. and this function execute before this ajax result so putting those code-function here.	
						},600);
					},
					error : function(e) {
						console.log("ERROR WHILE ADDING ROUTE DATA");
						//deleteRouteToServerStatus = false;
						afterDeleteRoute(false);							
					},
					done : function(e) {
						console.log("DONE");
						//deleteRouteToServerStatus = true;
					}
				});
			},1200);
			//return true;
		...
		//#########################################################################
			...
			function displayRouteOnMap(row){
				...
				for(var i=0;i<stopsLngLat.length;i++){
					...
					/*div style="border-radius:6px; border:1px solid #CCC; height:24px; margin-left:6px;width:200px; background-color:rgba(0,0,0,0.5);min-width:100px; max-width:300px; display: inline-block"><span><img src="images/stop1.png" height="24" width="24" style="margin-top:-2px; float:left"></span><span style="float:left;">' +x.name+'</span></div>*/
			...
			//alert("ranjit"+busStopCollection.length);
					$("#add_route_submit_message_alert").slideUp().fadeOut();	
					...
					console.log("Before Adding to add route form bus stop list: "+busStopCollection.length);
					
					$('#add_button_stop_dropdown').empty(); 		//emptying the any previous list first. 
						
					jQuery.each(busStopCollection, function(i, stop){
						console.log("Adding to add route form bus stop list: "+stop.name);
			...
			var routeStopsListToAddToServer;
			var routeNameToAddToServer;
			function submitRouteExtended(){
				routeNameToAddToServer = capitalizeFirstLetter($("#add_button_routeName").val());
				routeStopsListToAddToServer = [];
				$("#add_button_selected_stop_list tbody tr").each(function(i, val){
					routeStopsListToAddToServer.push($(val).find("td:nth-child(2)").text());
					console.log($(val).find("td:nth-child(2)").text());
				});
				//alert(stop_lists);
				if (routeNameToAddToServer==""){				
				...
				else if(routeStopsListToAddToServer.length==0){	
				...
				else if(checkForDuplicateRouteEntry(routeNameToAddToServer)==true){				
					...
					//some time delay .6 seconds effect while submitting
					setTimeout(function(){	
						//#########################################################################################################
						
						addRouteToServer(routeNameToAddToServer, routeStopsListToAddToServer);
						
						/*$.when(addRouteToServer(route_name, stop_lists)).done(function(){
							
						

						var date = new Date();
							console.log("After ajax stop: "+date.getHours()+":"+date.getMinutes()+":"+date.getSeconds());
									
							//setting time out so that the addrouteserver method will have time to set addRouteServerStatus variable.
							setTimeout(function(){
								var date = new Date();
								console.log("After ajax stop time set 200 ms. : "+date.getHours()+":"+date.getMinutes()+":"+date.getSeconds());
								
								//if the add is successful.
								if(addRouteServerStatus==true){
		...
		//this function is executed after the add route is called in server. and called from the ajax function.
		function afterAddRouteData(status){
							setTimeout(function(){
								var date = new Date();
								console.log("After ajax add route data. : "+date.getHours()+":"+date.getMinutes()+":"+date.getSeconds());
								...
								if(status==true){
									...
									//adding the new data to the local array
									var stopsWithLngLat = [];
									jQuery.each(routeStopsListToAddToServer, function(i, stop){
										jQuery.each(busStopCollection, function(i, stopObject){
											if(stopObject.name == stop){
												stopsWithLngLat.push(stopObject);		//adding the object itself.
												return true;	//exitting out of the loop.
									...
									//now adding to local array.
									routeCollection.push({name:routeNameToAddToServer, stops:stopsWithLngLat});
									//alert(JSON.stringify(routeCollection));
									
									//loading and updating the data to the page table
									loadRouteDataToTable(routeNameToAddToServer, routeStopsListToAddToServer);	
			...
			function displayDeleteRouteOption(){
				...
				if($("#display_route_table").find("tbody").children().length==0){
					...
					//hiding the map view icon on row.
			...
			function cancelRouteDeleteOption(){	
				...
				//Un hiding the map view icon on row.
				$("#display_route_table tbody").find("tr td:nth-child(3) span:nth-child(2)").hide();
			...
			var toDeleteRoutesToServer;
			function deleteRouteRowsExtended(){				
				$("#loading_1").fadeIn();
				
				//getting routes to delete
				toDeleteRoutesToServer = getRouteNameToDelete();
				
				//######################SERVER CODE ###############################
				
				deleteRouteToServer(toDeleteRoutesToServer); 
				
				//The below code is in sepatated function and called in ajax.
				
				
				/*$.when(deleteRouteToServer(toDeleteRoutesToServer)).done(function(){
				
					var date = new Date();
					console.log("Delete status After ajax stop: "+date.getHours()+":"+date.getMinutes()+":"+date.getSeconds());
								
					//setting time out so that the update routeserver method will have time to set updateRouteServerStatus variable.
					setTimeout(function(){
						var date = new Date();
						console.log("Delete status After ajax stop time set 900 ms. : "+date.getHours()+":"+date.getMinutes()+":"+date.getSeconds());
					
						//##################################################################
						
						if(deleteRouteToServerStatus==true){
							setTimeout(function(){
							
								//alert(JSON.stringify(routeCollection));
								//deleting the data from the local array.
								for(var i=0; i<toDeleteRoutesToServer.length;i++){
									for(var j=0; i<routeCollection.length;j++){
										if(routeCollection[j].name==toDeleteRoutesToServer[i]){
			...
			//This function is called after ajax response is reveiced from the ajax method
			function afterDeleteRoute(status){
				var date = new Date();
				console.log("This is after Delete code.. : "+date.getHours()+":"+date.getMinutes()+":"+date.getSeconds());
				...
				if($("#display_route_table").find("tbody").children().length==0){
					...
					$("#content_header_button_exit").click(function(){
						...
						setTimeout(function(){					
							...
							$("#loading_1").hide();							
							//unhiding the view map button
							$("#display_route_table tbody").find("tr td:nth-child(3) span:nth-child(2)").show();
						},600);
					});
			...
			//displayAddRouteForm();
				...
				//alert(stops);
					...
					$('#modal_update_route_stop_dropdown').empty();		//emptying any previous list first.
					jQuery.each(busStopCollection, function(i, stop){
						//$("#select_stop_from_list option").append('<option>'+stop.name+'</option>');
			...
			function updateEditRouteTable(route_row){
				...
				if (route_name==""){
					...
					if($("#modal_update_route_selected_stop_list").find("tbody").children().length!=0){													
						...
						//name must be similar to server java class RouteModel.java
						var route = {name:tempStoredRouteNameToUpdate, updatedRouteName:route_name, addedRouteStopNames:stops};
						...
						updatedRoutesToSendToServer.push(route);
			...
			function saveUpdatedRoutesDetail(){
				if(updatedRoutesToSendToServer.length==0){					
					...
					//####################################################################################
							...
							updateRouteToServer(updatedRoutesToSendToServer);
							
					/*$.when(updateRouteToServer(updated_Routes)).done(function(){
						
						var date = new Date();
						console.log("Update status After ajax stop: "+date.getHours()+":"+date.getMinutes()+":"+date.getSeconds());
									
						//setting time out so that the update routeserver method will have time to set updateRouteServerStatus variable.
						setTimeout(function(){
							var date = new Date();
							console.log("Update status After ajax stop time set 900 ms. : "+date.getHours()+":"+date.getMinutes()+":"+date.getSeconds());
							
							
							//####################################################################################	

							if(updateRouteServerStatus==true){
			...
			//THis funciton is executed after the update ajax is complete.
			function afterUpdateRouteData(status){
						setTimeout(function(){
							var date = new Date();
							console.log("Update status After ajax stop time set 900 ms. : "+date.getHours()+":"+date.getMinutes()+":"+date.getSeconds());
							...
							if(status==true){
								//updating the local array as well.
								//alert(JSON.stringify(routeCollection));
								jQuery.each(updatedRoutesToSendToServer, function(i,updatedRoute){
									jQuery.each(routeCollection, function(i,oldRoute){
										if(oldRoute.name==updatedRoute.original){			//FORMAT {original:tempStoredRouteNameToUpdate, updated:route_name, stops:stops};
											oldRoute.name=updatedRoute.updated;
											oldRoute.stops=updatedRoute.stops;
			...
			loadBusStopData();				//loading bus stop data because add update route form new bus stop list from this arraylist.
		...
		function addBusStopToServer(busStop){
			var date = new Date();
			console.log("Before add bus stop ajax start: "+date.getHours()+":"+date.getMinutes()+":"+date.getSeconds());
			
			console.log("Adding the bus stop to the server.");
			...
			$.ajax({
				...
				timeout : 100000,
				success : function(status) {
					console.log("SUCCESS LOADING BUS STOP DATA");
					console.log("success: "+status);
					//addRouteServerStatus = status;
					afterAddBusStopData(true);
				},
				error : function(e) {
					console.log("ERROR WHILE LOADING BUS STOP DATA");
					//addRouteServerStatus = false;
					afterAddBusStopData(false);
				},
				done : function(e) {
					console.log("DONE");
					//addRouteServerStatus = true;
		...
		function updateBusStopToServer(busStopLists){
			var date = new Date();
			console.log("Before update bus stop ajax start: "+date.getHours()+":"+date.getMinutes()+":"+date.getSeconds());
			
			console.log("Updating the bus stop to the server.");
			
			$.ajax({
				type : "POST",
				contentType : "application/json",
				url : "update_stops",
				data : JSON.stringify(busStopLists),
				dataType : 'json',
				timeout : 100000,
				success : function(status) {
					console.log("SUCCESS UPDATING BUS STOP DATA");
					console.log("success: "+status);
					//addRouteServerStatus = status;
					afterUpdateBusStopData(true);
				},
				error : function(e) {
					console.log("ERROR WHILE UPDATING BUS STOP DATA");
					//addRouteServerStatus = false;
					afterUpdateBusStopData(false);
				},
				done : function(e) {
					console.log("DONE");
					//addRouteServerStatus = true;
		...
		function deleteBusStopToServer(stopNames){
			var date = new Date();
			console.log("Before delete bus stop ajax start: "+date.getHours()+":"+date.getMinutes()+":"+date.getSeconds());
			
			console.log("deleting the bus stop to the server.");
			
			$.ajax({
				type : "POST",
				contentType : "application/json",
				url : "delete_stops",
				data : JSON.stringify(stopNames),
				dataType : 'json',
				timeout : 100000,
				success : function(status) {
					console.log("SUCCESS DELETING BUS STOP DATA");
					console.log("success: "+status);
					//addRouteServerStatus = status;
					afterDeleteBusStopData(true);
				},
				error : function(e) {
					console.log("ERROR WHILE DELETING BUS STOP DATA");
					//addRouteServerStatus = false;
					afterDeleteBusStopData(false);
				},
				done : function(e) {
					console.log("DONE");
					//addRouteServerStatus = true;
		...
		//#########################################################################################
			...
			//###################MAP SECTION ###############################################################
				...
				var is_bus_stop_tab_already_opened = false;
				...
				$("body").on("shown.bs.tab", "#bus_stop_tab_header", function() {
					...
					setTimeout(function(){map.invalidateSize()},6000);
					setTimeout(function(){map.invalidateSize()},7000);
					setTimeout(function(){map.invalidateSize()},8000);
					
					//tab loading animation
					//firstTimeTabLoadinAnimation();
					if(is_bus_stop_tab_already_opened==false){
						loadBusStopData();
						is_bus_stop_tab_already_opened = true;
					}
				});
				...
				function displayBusStopPositionInMap(){
					$("#display_bus_stop_table tbody").children().on("click",function(){
						console.log("map_add_bus_stop_status: "+map_add_bus_stop_status);
						if(map_add_bus_stop_status==false){
							...
							map.setView([ lat, lng ], 17, {animate: true, reset: true});
							map.invalidateSize();	//map will not animate and show the marker position so using this.
						}
					});
				};	
			...
			//##############ADD BUS STOP SECTION ###########################################################################
				...
				function addBusStopDetails(){
					...
					//all are correct
						...
						busStopToAddToServer = {name:name, latitude:lat, longitude:lng};
						setTimeout(function(){
							...
							addBusStopToServer(busStopToAddToServer);
				...
				//This function is executed after add bus stop ajax finished.
				function afterAddBusStopData(status){
					if(status == true){
						//alert(JSON.stringify(busStopCollection));
						//adding the data to local array.
						busStopCollection.push(busStopToAddToServer);
						//alert(JSON.stringify(busStopCollection));
						
						//adding data to page table
						addBusStopToTableList(busStopToAddToServer.name, busStopToAddToServer.longitude, busStopToAddToServer.latitude);
				...
				if(condition==true){
					...
					$("#display_bus_stop_table tbody").children().on("click",function(){
						if(map_add_bus_stop_status==false){
							...
							marker1 = new L.marker([ lat, lng ], {draggable:false});
							map.addLayer(marker1);	
							map.setView([ lat, lng ], 18, {animate: true, reset: true});
						}
					});
				}
			}
			...
			var map1 =new L.Map("bus_stop_update_map", {
					layers: [new L.tileLayer('http://localhost:8080/1.0.0/osm/{z}/{x}/{y}.png',{tms: true, attribution: '&copy; <a href="http://openstreetmap.org">OpenStreetMap</a> contributors'})]	
				});
			...
			function openEditBusStopModal(bus_stop){
				...
				marker = new L.marker([co_ordinates[1],co_ordinates[0]], {draggable:true});
							...
							map1.setView([co_ordinates[1],co_ordinates[0]], 17, {animate: true, reset: false});
				...
				setModalLongLatAndMarkerOnClick(map1);
				//marker = new L.marker([co_ordinates[1],co_ordinates[0]], {draggable:true});
				//map.addLayer(marker);				
			...
			var updatedBusStopsToSendToServer = [];
			//This function writes updated routes details to the edit mode table which will later saved after save button clicked.
			...
			function updateEditBusStopTable(row){
				...
				//checking for duplicate entry
					...
					var bus_stop = {name:originalBusStopNameBeforeUpdate, updatedName:stop_name, longitude:lng, latitude:lat};
					
					//now adding the bus stop object list to main array collection.
					//var index = updatedBusStopsToSendToServer.length;
					//updatedBusStopsToSendToServer[index] = bus_stop;
					updatedBusStopsToSendToServer.push(bus_stop);
			...
			function saveUpdatedBusStopDetail(){
				if(updatedBusStopsToSendToServer.length==0){					
					...
					setTimeout(function(){					
						...
						updateBusStopToServer(updatedBusStopsToSendToServer);
						...
						/*if(serverStatus==true){
							...
							jQuery.each(updatedBusStopsToSendToServer, function(i,updated_stop){
						...
						//jQuery.each(updatedBusStopsToSendToServer, function(i, val){						
			...
			//this function is executed after the update bus stop ajax is finished.
			function afterUpdateBusStopData(status){
				if(status==true){
					...
					$("#bus_stop_save_success_message").slideDown().fadeIn();
					$("#bus_stop_save_success_message").focus();
					$("#bus_stop_save_success_message").blur();
					setTimeout(function(){
						$("#bus_stop_save_success_message").slideUp().fadeOut();
					},5000);
					//reverting the edited row color to original color and font.
					...
					$("#bus_stop_save_danger_message").slideDown().fadeIn();
					$("#bus_stop_save_danger_message").focus();
					$("#bus_stop_save_danger_message").blur();
					setTimeout(function(){
						$("#bus_stop_save_danger_message").slideUp().fadeOut();
					},5000);
				}
		...
		//this function get out of the delete option mode
			...
			var toDeleteStopsToSendToServer;
			function deleteBusStopRowsExtended(){				
				...
				toDeleteStopsToSendToServer = getBusStopNameToDelete();	
				...
				deleteBusStopToServer(toDeleteStopsToSendToServer);
				...
				/*if(deleteStatus == true){
					...
					//alert(JSON.stringify(busStopCollection));
					for(var i=0; i<toDeleteStopsToSendToServer.length;i++){
						for(var j=0; i<busStopCollection.length;j++){
							if(busStopCollection[j].name==toDeleteStopsToSendToServer[i]){
			...
			//This function is executed after ajax call to delete all bus stops.
			function afterDeleteBusStopData(status){
				if(status == true){
					deleteBusStopRows();		//deleting rows in displayed table
			...
			function loadRouteWayData(){
				...
				//emptying the array first if it is refresh.
				way_available_routes =[]; 
				routeWaysCollection =[];
				way_not_available_routes = [];	
				...
				setTimeout(function(){
					$.ajax({
						...
						timeout : 100000,
						success : function(data) {
							console.log("SUCCESS LOADING ROUTE WAY DATA");
							//updateRouteServerStatus = status;
							way_available_routes =data.routeWayAvailableStops; //this is example to mimic data from server
							routeWaysCollection = data.routeWay;
							way_not_available_routes =data.routeWayNotAvailableStops;							
							loadRouteWayDataToPage();
							
							$("#loading_1").fadeOut();					
							$("#route_way_span_container").fadeIn();
							
							//map show error or is not properly displaying so invalidating.
							...
							setTimeout(function(){map_route_way.invalidateSize()},3000);
							setTimeout(function(){map_route_way.invalidateSize()},4000);
							setTimeout(function(){map_route_way.invalidateSize()},6000);
							setTimeout(function(){map_route_way.invalidateSize()},8000);
							setTimeout(function(){map_route_way.invalidateSize()},9000);
						},
						error : function(e) {
							console.log("ERROR WHILE LOADING ROUTE WAYDATA");
							$("#loading_1").fadeOut();					
							$("#route_way_span_container").fadeIn();	
							//updateRouteServerStatus = false;	
							way_available_routes =[]; //this is example to mimic data from server
							routeWaysCollection =[];
							way_not_available_routes = [];							
							loadRouteWayDataToPage();
			...
			function addRouteWayToServer(routeWay, routeRow){
				console.log("Adding new route way data.");
				setTimeout(function(){
					$.ajax({
						type : "POST",
						contentType : "application/json",
						url : "save_route_way",
						data : JSON.stringify(routeWay),
						dataType : 'json',
						timeout : 100000,
						success : function(data) {
							console.log("SUCCESS ADDING ROUTE WAY DATA");
							//updateRouteServerStatus = status;
							afterAddRouteWayData(true, routeRow);
						},
						error : function(e) {
			...
			function updateRouteWayToServer(routeWay){
			...
			console.log("Updating route way.");
				setTimeout(function(){
					$.ajax({
						type : "POST",
						contentType : "application/json",
						url : "update_route_way",
						data : JSON.stringify(routeWay),
						dataType : 'json',
						timeout : 100000,
						success : function(data) {
							console.log("SUCCESS UPDATING ROUTE WAY DATA");
							//updateRouteServerStatus = status;
							afterUpdateRouteWayData(true);
						},
						error : function(e) {
							console.log("ERROR WHILE UPDATING ROUTE WAY DATA");
							//updateRouteServerStatus = false;	
							afterUpdateRouteWayData(false);						
						},
						done : function(e) {
							console.log("DONE");
							//updateRouteServerStatus = true;
			...
			function deleteRouteWayToServer(routeName, route){
				console.log("Deleting route way.");
				setTimeout(function(){
					$.ajax({
						type : "POST",
						contentType : "application/json",
						url : "delete_route_way",
						data : routeName,
						dataType : 'json',
						timeout : 100000,
						success : function(data) {
							console.log("SUCCESS DELETING ROUTE WAY DATA");
							//updateRouteServerStatus = status;
							afterDeleteRouteWayData(true, route);
						},
						error : function(e) {
							console.log("ERROR WHILE DELETING ROUTE WAY DATA");
							//updateRouteServerStatus = false;	
							afterDeleteRouteWayData(false, route);						
						},
						done : function(e) {
							console.log("DONE");
							//updateRouteServerStatus = true;
			...
			function loadRouteWayDataToPage(){
				...
				$("#display_added_route_way_table tbody").empty();  //clearing the tbale first.
				$("#display_not_added_route_way_table tbody").empty();
			...
			*/
			...
			function openAddRouteWay(route){
				...
				if(is_route_way_add_available==false){					
					...
					//getting row route name 				
					toAddRouteWayName = $(route).parent().find("span:nth-child(1)").text();
					$(route).parent().parent().focus();
					...
					$("#route_way_add_mode_name").text(toAddRouteWayName).hide().fadeIn();	
					...
					$("#route_way_add_mode_add_button").on('click', function(){
						...
						//if not already added then add route.
							...
							if (wayMarkersGroup.getLayers().length!=0){														
								...
								addRouteWayData(toAddRouteWayName, route);  //calling function to delete route.
								
								/*if(afterAddRouteWayDataStatus==true){
									...
									$("#route_way_add_mode_exit").on('click', function(){
										//clearing the map layers
										wayMarkersGroup.clearLayers();
										//resetting marker index so that when adding new route way marker wil start from 1. not last added value.
										markerIndex = 1;
				...
				setTimeout(function(){	
					...
					$(row).parent().parent().fadeOut(300, function(){
						...
						if($("#display_not_added_route_way_table tbody").children().length==0){
							$("#display_route_way_not_added_table_not_available").fadeIn();
							$("#display_not_added_route_way_table").fadeOut();
							console.log("Route way Not available table list is empty.");
						}
						else{
							$("#display_route_way_not_added_table_not_available").fadeOut();
							$("#display_not_added_route_way_table").fadeIn();
							console.log("Route way Not available table list is not empty.");
						}
						});
					},3000);
					
				$("#display_added_route_way_table").fadeIn();
				$("#display_route_way_added_table_not_available").fadeOut();
				
				console.log("Adding and shifting the route row to Available table: "+row_name);
		...
		//}
			...
			var toAddRouteWayToServer;
			function addRouteWayData(route_name, routeRow){				
				$("#loading_2").fadeIn();
				...
				toAddRouteWayToServer = {name:route_name, wayLine:markerLatLngObjects};		//creating a route object.
				//var str = JSON.stringify(routeWay);
				//###########################################################################
				//				SERVER CODE 
				
				//alert(JSON.stringify(routeWay));
				addRouteWayToServer(toAddRouteWayToServer, routeRow);
			...
			//This function is executed after the ajax request to add route way data.
			function afterAddRouteWayData(status, routeRow){
			var afterAddRouteWayDataStatus = false;
				if(status==true){				
				console.log("After route way data add status is true.");	
					setTimeout(function(){					
						$("#route_way_add_mode_add_button").prop('disabled',false);
						$("#loading_2").fadeOut();
						//alert(str);
					...
					//alert(JSON.stringify(routeWaysCollection));
						//adding the added routeWay object in the all route way collection so that it can viewed from clicking view route way button in added Routeway section's route row option menu.
						routeWaysCollection.push(toAddRouteWayToServer);
						
					//alert(JSON.stringify(routeWaysCollection));
						
					},1600);
					afterAddRouteWayDataStatus = true;
				}
				else{				
					$("#route_way_add_mode_add_button").prop('disabled',false);
					$("#loading_2").fadeOut();
					afterAddRouteWayDataStatus = false;
				}
				if(afterAddRouteWayDataStatus==true){
					//deleting the row from not added list and adding to added list
					...
					//is_route_way_add_available=true;		//setting the add option available so that other can be easily added without exiting the current one. since, already added, there is issue of data lost if other route add displayed without notification.
					setTimeout(function(){					
						shiftRowToAddedList(routeRow, toAddRouteWayName);
					},3000);							
				...
				//if server return error  display message.
					...
					//setting the default row name
					$(routeRow).parent().find("span:nth-child(1)").text(row_name);									
			...
			function displayResetButtonInMap(){
				...
				var is_route_way_tab_already_opened = false;
				...
				$("body").on("shown.bs.tab", "#route_way_tab_header", function() {
					...
					if(is_route_way_tab_already_opened==false){
						loadRouteWayData();
						is_route_way_tab_already_opened = true;
					}
				});
				...
				if(is_route_way_add_available==false){					
					...
					$("#route_way_update_mode_add_button").on('click', function(){
						...
						if (wayMarkersGroup.getLayers().length!=0){														
							...
							updateRouteWay(row_name);	//Update the route data	
							
							/*if(afterUpdateRouteWayDataStatus==true){
			...
			var toUpdateRouteWayToSendToServer;
			var toUpdateRouteWayRouteNameToSendToServer;
			function updateRouteWay(route_name){	
				toUpdateRouteWayRouteNameToSendToServer = route_name;
				//loading animations
				$("#loading_2").fadeIn();
				//disabling the add button
				...
				//getting the long lat from the all marker and adding it to the collectin
					...
					toUpdateRouteWayToSendToServer = {name:toUpdateRouteWayRouteNameToSendToServer, wayLine:markerLatLngObjects};		//creating a route object.
					//var json_routeWay = JSON.stringify(routeWay);
					
					//####################################################################################################
					//SERVER CODE
					
					updateRouteWayToServer(toUpdateRouteWayToSendToServer);
			...
			//this function is executed after the ajax calling to update routeway 
			function afterUpdateRouteWayData(status){
			var afterUpdateRouteWayDataStatus = false;
				if(status==true){
					setTimeout(function(){					
						$("#route_way_update_mode_add_button").prop('disabled',false);
						$("#loading_2").fadeOut();
					...
					//for each route_way in collection if the route name is this edited routename then replace.
					jQuery.each(routeWaysCollection, function(i, collection){
						if(collection.name==toUpdateRouteWayRouteNameToSendToServer){
							//collection.splice();
							routeWaysCollection[i] = toUpdateRouteWayToSendToServer;		//replacing with updated route way.
						}						
					});
					afterUpdateRouteWayDataStatus = true;				
				}
				else{						
					$("#route_way_update_mode_add_button").prop('disabled',false);
					$("#loading_2").fadeOut();
					afterUpdateRouteWayDataStatus = false;
				}
				
				if(afterUpdateRouteWayDataStatus==true){
							console.log("Route way update successful.");
								//some delay while displaying success message.
								setTimeout(function(){									
									//displaying success message.									
									console.log("Route way update successful.");
			...
			//This function is triggered from option menu view Way. displays the way of the route on map.
			var toDeleteRouteWayNameToSendToServer;
			function deleteRouteWay(route){	
				...
				toDeleteRouteWayNameToSendToServer = $(route).parent().parent().parent().find("span:first").text();					
					
					//displaying confirm alert					
					$("#action_modal_exit_title").text("WARNING!!! DELETE ROUTE WAY?");
					$("#action_modal_exit_content").text("Are you sure want to delete "+toDeleteRouteWayNameToSendToServer.toUpperCase()+"'s route way? Once deleted it can not be recovered. Please, Confirm.");
					$("#action_modal_exit").modal('show');
					...
					$("#action_modal_exit_ok").on('click',function(){
						...
						//####################################################################################
						deleteRouteWayToServer(toDeleteRouteWayNameToSendToServer, route);
			...
			//this function is executed after the routeway delete ajax executed.
			function afterDeleteRouteWayData(status, route){
				if(status==true){
					//deleting from the local array
					//alert("before delete routewaycollection count: "+routeWaysCollection.length);
					jQuery.each(routeWaysCollection, function(i, routeWay){
						if(routeWay.name==toDeleteRouteWayNameToSendToServer){
							routeWaysCollection.splice(i,1);			//deleting the routeWay Object from the collection./local array
							return false;
						}						
					});
					...
					//alert("After delete routewaycollection count: "+routeWaysCollection.length);	
					setTimeout(function(){
						shiftRowToNotAddedList($(route).parent().parent().parent().parent(), toDeleteRouteWayNameToSendToServer);
					},1600);
				}
				else{					
					$("#alert_modal_title").text("WARNING!!! DELETE UNSUCCESSFUL.");
					$("#alert_modal_content").text(" Cannot delete the route way at the moment. Please, try again later.");
					$("#alert_modal").modal('show');
				}
			}
				...
				setTimeout(function(){	
					...
					$(row).fadeOut(500, function(){
						...
						if($("#display_added_route_way_table tbody").children().length==0){
							$("#display_route_way_added_table_not_available").fadeIn();
							$("#display_added_route_way_table").fadeOut();
							console.log("Route way available table list is empty.");
						}
						else{							
							$("#display_route_way_added_table_not_available").fadeOut();
							$("#display_added_route_way_table").fadeIn();
							console.log("Route way available table list not is empty.");
						}
					});
					...
					console.log("Adding the route name into the Not-Available table :"+row_name);
			...
			function loadStopsDistanceData(){			
				...
				console.log("Loading route stop distance data.");
				$("#loading_1").fadeIn();	
				$("#stops_distance_span_container").hide();
				setTimeout(function(){
					$.ajax({
						type : "POST",
						contentType : "application/json",
						url : "load_stops_distance",
						dataType : 'json',
						timeout : 100000,
						success : function(data) {
							console.log("SUCCESS LOADING ROUTE STOPS DISTANCE DATA.");
							//updateRouteServerStatus = status;
							stopsDistanceCollection = data;								
							$("#loading_1").fadeOut();					
							$("#stops_distance_span_container").fadeIn();
						},
						error : function(e) {
							console.log("ERROR WHILE LOADING ROUTE STOPS DISTANCE DATA.");
							//updateRouteServerStatus = false;				
							$("#loading_1").fadeOut();					
							$("#stops_distance_span_container").fadeIn();							
						},
			...
			function updateStopsDistanceToServer(update_stops_distance, toSaveRouteDistance){
				console.log("Loading route stop distance data.");
				...
				setTimeout(function(){
					$.ajax({
						type : "POST",
						contentType : "application/json",
						url : "update_stops_distance",
						data : JSON.stringify(update_stops_distance),
						dataType : 'json',
						timeout : 100000,
						success : function(data) {
							console.log("SUCCESS UPDATING ROUTE WAY DATA");
							//updateRouteServerStatus = status;
							afterRouteStopsDistanceToServer(true, toSaveRouteDistance);
							
						},
						error : function(e) {
							console.log("ERROR WHILE UPDATING ROUTE WAY DATA");
							//updateRouteServerStatus = false;	
							afterRouteStopsDistanceToServer(false, toSaveRouteDistance);						
						},
						done : function(e) {
							console.log("DONE");
							//updateRouteServerStatus = true;
			...
			//############################################################################################################################################
					...
					var is_stops_distance_data_loaded = false;
				$("body").on("shown.bs.tab", "#stops_distance_tab_header", function() {
					...
					//enabling the loading animation
					//firstTimeTabLoadinAnimation();
					if(is_stops_distance_data_loaded==false){
						loadStopsDistanceData();			//loading data
						is_stops_distance_data_loaded = true;						
					}					
				});
			...
			function loadStopsDistanceRouteToPage(){
				...
				//displaying the Added route way table on side panel
					...
					$("#stops_distance_route_table tbody").empty();				
					jQuery.each(routeCollection, function(i, route){
			...
			function addDataToStopsDistanceTable(data){
				//alert(JSON.stringify(data));
					$("#stops_distance_table tbody").empty();
				jQuery.each(data, function(i, val){
					$("#stops_distance_table tbody").append('<tr tabindex="1"><td width="10%">'+parseInt(i+1)+'</td><td style="padding-left:24px">'+val.distance+" Km"+'</td><td style="padding-left:24px">'+val.stopName+'</td></tr>');
				}); 				
			}
			...
			function addDataToStopsDistanceEditTable(data, routeName){
				...
				//alert(JSON.stringify(data));
					$("#stops_distance_table tbody").empty();
				jQuery.each(data, function(i, val){
					$("#stops_distance_table tbody").append('<tr tabindex="1"><td width="10%">'+parseInt(i+1)+'</td><td style="padding:0px"><input type="text" class="form-control" placeholder="Enter distance" aria-describedby="basic-addon1" style="height:24px; padding:0px;padding-left:8px" value="'+val.distance+'"></td><td style="padding-left:24px">'+val.stopName+'</td></tr>');
				}); 				
			}
			...
			function saveStopsDistance(){
				...
				$("#stops_distance_table tbody").find("tr").each(function(i, row){
					toSaveRouteDistance.push({distance:$(row).find("td:nth-child(2) input").val(),name:$(row).find("td:nth-child(3)").text()});
				});
				...
				var toUpdateData = {name:currentStopsDistanceEditRoute, distanceData:toSaveRouteDistance};	
				...
				setTimeout(function(){
					...
					updateStopsDistanceToServer(toUpdateData, toSaveRouteDistance);
			...
			//This function is executed after the ajax call for update route stop distance data.
			function afterRouteStopsDistanceToServer(status, toSaveRouteDistance){
				if (status==true){
						$("#stops_distance_save_succes_message").slideDown().fadeIn();
						setTimeout(function(){
							$("#stops_distance_save_succes_message").slideUp().fadeOut();
