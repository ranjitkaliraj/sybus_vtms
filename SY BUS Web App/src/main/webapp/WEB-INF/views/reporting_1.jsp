   ...
   <body>
      ...
      <div class="row" style="height:100%; width:auto">
		...
		<div style="margin:-22px">
		  ...
		  <li class="active"><a style="font-weight:normal; background:none;color:#000;border:1px solid #9E9E9E" href="#">Route with Most Passenger Travelling Report</a></li>
		...
		<div class="col-sm-10 col-sm-offset-2 col-md-10 col-md-offset-2 main" style="margin-bottom:40px;height:100%; width:89%">
		  ...
		  <div style="margin-left:-42px;margin-right:-42px;margin-top:-32px; height:100%; width:100%">
				...
				<div id="content_header">
				  <h3><span style="color:#4CAF50; margin-left:8px;" id="content_header_title">Route with Most Passenger Travelling</span><small id="content_header_subtitle">  Generated Report</small>
				...
				<div class="container-fluid col-md-12" style="padding-left:60px; padding-right:60px; margin-top:12pxoverflow-y:auto!important">
				  ...
				  <h1 id="active_vehicle_side_table_list_not_available_message" style="display:none; color:#CCC; font-weight:bold; margin-top:200px;">Report Not Available.</h1>
				...
				<br>
				<h4 style="float:left">REPORT TITLE: <span style="color:#686868">Route with Most Passenger Travelling</span> </h4>
				<br><br>
				<h5 style="float:left">Duration: <span style="color:#686868" id="duration_text">All Time.</span> </h5>
				</div>			
				<div class="col-xs-12 panel-body" style="min-height:392px; padding:14px; font-family:Arial, Helvetica, sans-serif; font-size:12px">
						...
						<th style="text-align:center" width="60%">TOTAL PASSENGERS</th>
						</tr>
						</thead>
						<tbody>	
	  ...
	  <script type="text/javascript">
		$(document).ready(function() {	
			...
			//sample data///all 4 type need to download at once on page load.
			var data1 = {route_name:"Route 1", total_passenger:5445};		//all time data
			var data2 = {route_name:"Route 2", total_passenger:5445};		//today data-
			var data3 = {route_name:"Route 3", total_passenger:5445};		//last week data
			var data4 = {route_name:"Route 4", total_passenger:5445};		//last month data.
			
			//this functions get and load the roport data.
			function loadData(data){
				$("#table tbody").empty();
				$("#table tbody").append('<tr><td>'+1+'</td><td style="text-align:center">'+data.route_name+'</td><td style="text-align:center">'+data.total_passenger+'</td></tr>');
			}
