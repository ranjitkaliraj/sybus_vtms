   ...
   <body>
      ...
      <div class="row" style="height:100%; width:auto">
		...
		<div style="margin:-22px">
		  ...
		  <li class="active"><a style="font-weight:normal; background:none;color:#000;border:1px solid #9E9E9E" href="#">Registered Passenger Details Report</a></li>
		...
		<div class="col-sm-10 col-sm-offset-2 col-md-10 col-md-offset-2 main" style="margin-bottom:40px;height:100%; width:89%">
				...
				<div id="content_header">
				  <h3><span style="color:#4CAF50; margin-left:8px;" id="content_header_title">Registered Passenger Details</span><small id="content_header_subtitle">  Generated Report</small>
					...
					<div id="sort" class="input-group" style="padding:0px;margin:0px; float:right; width:180px; margin-right:8px; margin-top:2px">
							<span class="input-group-addon" style="height:24px; padding:4px;margin:0px; font-weight:normal font-size:12px; background:none">Duration</span>
							  <select id="duration_dropdown" style="height:24px; font-size:12px; padding:0px; color:#424242" class="form-control tooltip-bottom" placeholder="apple" title="Select Bus stop from the list." onChange="getDataByDuration()" disabled="disabled">
		...
		<!--<h1 class="page-header" style="margin-top:-10px">Dashboard</h1>-->
		  <div style="margin-left:-42px;margin-right:-42px;margin-top:8px; height:100%; width:100%; overflow-y:auto">
				...
				<br>
				<h4 style="float:left">REPORT TITLE: <span style="color:#686868">Registered Passenger Details</span> </h4>
				<br><br>
				</div>			
				<div class="col-xs-12 panel-body" style="min-height:410px; padding:14px; font-family:Arial, Helvetica, sans-serif; font-size:12px">
				  
						<!--route table.-->
						<table class="table table-condensed table-striped table-bordered" media='print' id="table">
						<!--<caption style="font-size:16px">PASSENGER INFORMATION REPORT</caption-->
						<thead>
						<tr style="background:#424242; color:#CCC">
						<th style="text-align:center" width="2%">SN</th>
						<th style="text-align:center" width="38%">NAME</th>
						<th style="text-align:center" width="60%">EMAIL ADDRESS</th>
						</tr>
						</thead>
						<tbody>	
	  ...
	  <script type="text/javascript">
		$(document).ready(function() {	
			...
			//sample datas.
			var p1 ={name:"Ranjit Kaliraj", email:"ranjit.kaliraj@gmail.com"};
			var p2 ={name:"Dipkar Uprety", email:"diplkary@gmail.com"};
			var p3 ={name:"Ram hari", email:"ramhari@gmail.com"};
			var p4 ={name:"Tika Ram thapa", email:"tikaram@gmail.com"};
			var p5 ={name:"Mohmmad Ashiq ali", email:"mohmmad@gmail.com"};
			var p6 ={name:"Puri khan", email:"puri@gmail.com"};
			var p7 ={name:"Salman Khan", email:"salman@gmail.com"};
			var p8 ={name:"Sohail khan", email:"sohailj@gmail.com"};
			var p9 ={name:"Shahruck khan", email:"safsfdsf@gmail.com"};
			var p10 ={name:"Nikesh Shrestha", email:"nikesh@gmail.com"};
			...
			passengerCollection.push(p1,p2,p3,p4,p5,p6,p7,p8,p9,p10);
			...
			function loadData(){
				...
				if(passengerCollection.length==0){
					$("not_available_mesage").fadeIn();				
				}
				else{
					$("#not_available_mesage").hide();					
					//route table
					jQuery.each(passengerCollection, function(i, val){
						$("#table tbody").append('<tr><td>'+parseInt(i+1)+'</td><td style="text-align:center">'+val.name+'</td><td style="text-align:center">'+val.email+'</td></tr>');
					});
					$("#table").fadeIn();
				}
			}
